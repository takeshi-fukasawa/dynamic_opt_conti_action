function [I_t_updated,basis_t1,geval]=Newton_func0(...
    ...
    %%% Second derivatives required in the Newton's iterations are computed using numerical derivatives
...
for j=1:N
    ...
    for ITER_Newton_j=1:ITER_MAX_Newton
        ...
        if spec_precompute==1
            ...
            [basis_t1_j_eps,V_t1_diff_j_eps]=...
            V_t1_func_precompute(k_t1_eps_j,basis_exo_t1,...
            coef_approx_V(:,j,:),state_min,state_max,Smol_elem,mu_max,ind,w_inv);
