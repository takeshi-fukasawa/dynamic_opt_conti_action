function I_updated=I_update_func(I_initial,k_t,V_t1_diff,stoch_inv_cost,theta,algorithm_spec,I_min,I_max)
...
elseif algorithm_spec=="gradient" % algorithm_spec=="analytical"
