...
DIST_PM_spectral=iter_info_PM_spectral.DIST_table(iter_info_PM_spectral.feval,:);

results_grad_spectral=[round(iter_info_grad_spectral.t_cpu,2),iter_info_grad_spectral.feval,iter_info_grad_spectral.geval_total,...
    log10(DIST_grad_spectral)];
results_PM_spectral=[round(iter_info_PM_spectral.t_cpu,2),iter_info_PM_spectral.feval,iter_info_PM_spectral.geval_total,...
    log10(DIST_PM_spectral)];
