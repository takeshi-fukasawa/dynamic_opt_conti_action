...
results_grad_spectral=[round(iter_info_grad_spectral.t_cpu,2),iter_info_grad_spectral.feval,...
    log10(DIST_grad_spectral)];
results_PM_spectral=[round(iter_info_PM_spectral.t_cpu,2),iter_info_PM_spectral.feval,...
